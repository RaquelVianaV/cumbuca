...
test('navigation, finance, reports and maintenance expose the expected views', () => {
  ...
  assert.match(app, /divisionSavingsDeposits = Number\(data\.financial\?\.withdrawals\?\.savings/);
  ...
  assert.match(app, /function repairFinancialAccountCategories/);
  ...
  assert.match(app, /Semanal: \$\{data\.weeklyCashQuantity\}/);
